...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <h3>
                <i class="glyphicon glyphicon-user"></i><?=$DashboardResult['degree']."&nbsp".$DashboardResult['username']?>
            </h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                    <br><?php echo Html::img('/'.$DashboardResult['headimage'],['class' =>'img-responsive','width'=>'150px','alt'=>'用户未上传头像']);?>
                    ...
                    <a href=<?=Url::to(['message/messagetome'])?> class="list-group-item">
                        <span class="badge"><?=$DashboardResult['messagetome']?></span>我的站内信</a>
                    ...
                    <a href=<?=Url::to(['donate/donatetome'])?> class="list-group-item">
                        <span class="badge"><?=$DashboardResult['donatetome']?></span>我的心愿</a>
                    <a href=<?=Url::to(['donate/mydonation'])?> class="list-group-item">
                        <span class="badge"><?=$DashboardResult['mydonation']?></span>我的资助</a>
                    <a href=<?=Url::to(['class/myclasses'])?> class="list-group-item">创建的团体</a>  
                    <a href=<?=Url::to(['class/classesincludeme'])?> class="list-group-item">
                        <span class="badge"><?=$DashboardResult['classesincludeme']?></span>加入的团体</a>       
        ...
        <div class="col-md-9">
            <h3>账户余额:&nbsp<?=$DashboardResult['money']?>元 &nbsp&nbsp&nbsp
...
function printtableend()
{
    ...
    {
        printtablebody($model['id'],$model['tradetime']->format('Y-m-d H:i:s'),$model['type'],$model['mount'],$model['status'],'');
    }
    printtableend();
    $maxButtonCount = 10;
